 ...
 */
public class UnstarSpeciesTask extends AsyncTask<Void, Void, MainSpeciesListResponse> {
    ...
    public UnstarSpeciesTask(BjorneparkappenApi.Builder builder, HomeActivity activity, String language, long visitorId, Species species) {
