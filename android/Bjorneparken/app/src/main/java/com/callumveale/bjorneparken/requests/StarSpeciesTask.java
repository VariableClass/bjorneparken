 ...
 */
public class StarSpeciesTask extends AsyncTask<Void, Void, Void> {
    ...
    public StarSpeciesTask(BjorneparkappenApi.Builder builder, HomeActivity activity, long visitorId, Species species) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            mBuilder.build().visitors().starredSpecies().add(request).execute();
