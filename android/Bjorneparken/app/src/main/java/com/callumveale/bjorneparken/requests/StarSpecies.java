...
public class StarSpecies extends AsyncTask<Void, Void, Void> {

    private HomeActivity activity;
    private long visitorId;
    private Species species;

    public StarSpecies(HomeActivity activity, long visitorId, Species species) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            builder.build().visitors().starredSpecies().add(request).execute();
