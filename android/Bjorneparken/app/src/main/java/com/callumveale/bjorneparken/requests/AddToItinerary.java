...
public class AddToItinerary extends AsyncTask<Void, Void, Void> {

    private HomeActivity activity;
    private long visitorId;
    private Event event;

    public AddToItinerary(HomeActivity activity, long visitorId, Event event) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            builder.build().visitors().itinerary().add(request).execute();
